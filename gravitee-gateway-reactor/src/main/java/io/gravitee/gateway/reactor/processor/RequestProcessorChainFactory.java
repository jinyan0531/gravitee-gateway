...
import io.gravitee.gateway.core.processor.chain.SimpleProcessorChain;
...
public class RequestProcessorChainFactory {
    ...
    private List<Processor<ExecutionContext>> requestProcessors = new ArrayList<>();

    @PostConstruct
    public void init() {
        requestProcessors.add(transactionHandlerFactory.create());
    }

    public SimpleProcessorChain<ExecutionContext> get() {
